...
app.layout = html.Div([
    ...
    html.H1("Automobile Statistics Dashboard", style={'texAlign': 'center', 'color': '#503D36', 'font-size': 24}),#May include style for title
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        unemp_rate=data.groupby('unemployment_rate')['Automobile_Sales'].mean().reset_index()                           
        R_chart4  = dcc.Graph(
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        Y_chart3 = dcc.Graph( 
                figure=bar.pie(avr_vdat,
                x='Month',
                y='Automobile_Sales',
                title="Average Vehicles Sold"))
